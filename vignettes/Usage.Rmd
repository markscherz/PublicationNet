---
title: "Usage of PublicationNet"
output: rmarkdown::github_document
vignette: >
  %\VignetteIndexEntry{PublicationNet}
...
From this you can generate the network and a tally of occurrences of each coauthor in the list in a single step

```{r generate coauthor network, eval=FALSE}
conet<-coauthor_network(refs)
```

Then you can plot this with ggraph.

```{r generate plot, eval=FALSE}
...
On dense networks, you will lose a lot of author names; to keep all and allow graphical editing in a vector-editing software, try
